          ...
          <div className="w-full h-full bg-gradient-to-l from-red-500 to-orange-500 flex justify-center items-center">
            <div className="pb-[100px]">
              ...
              <div className="mt-5 w-full flex flex-col justify-center items-center">
                <Input className="m-2 w-[450px] h-12 rounded-xl max-[1500px]:w-[400px] max-[450px]:w-[350px] max-[400px]:w-[300px]" placeholder="Имя" />
                <Input className="m-2 w-[450px] h-12 rounded-xl max-[1500px]:w-[400px] max-[450px]:w-[350px] max-[400px]:w-[300px]" placeholder="Фамилия" />
              ...
              <div><a onClick={goAuth} className="cursor-pointer hover:underline hover:text-blue-400 text-white text-2xl max-[1500px]:text-xl max-[400px]:text-lg">Вернуться назад?</a></div>
